...
def wanweiba(images: list[BuildImage], texts, args):
    avatar_states = [[(738, 132, 289, 303, 0, True, False), (738, 132, 289, 303, 0, True, False), (738, 132, 289, 303, 0, True, False), (738, 132, 289, 303, 0, True, False), (738, 132, 289, 303, 0, True, False), (738, 132, 289, 303, 0, True, False)]]
    frames: list[IMG] = []
    for i in range(6):
